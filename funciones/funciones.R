...
auxiliares<-function(base){
  ...
  base %>%  mutate(INF = case_when(
    PP07H==2 &  PP04C>5 & PP04B1==2  ~  "inf_for",
    PP07H==2 &  PP04C<6 & PP04B1==2 ~ "inf_inf",
    PP07H==2 & PP04B1==1 ~ "inf_hog",
    PP07H==1 & PP04B1==1 ~ "form_hog",
    PP07H==1 &  PP04C>5 & PP04B1==2   ~ "form_form",
    PP07H==1 &  PP04C<6 & PP04B1==2   ~ "form_inf"))->base
